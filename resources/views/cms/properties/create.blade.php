...
<section class="dash_content_app">
    ...
    <div class="dash_content_app_box">
        ...
        <div class="nav">
            ...
            <form action="{{ route('cms.properties.store') }}" method="post" class="app_form" enctype="multipart/form-data">
                @csrf
                <div class="nav_tabs_content">
                    <div id="data">
                        ...
                        <label class="label">
                            ...
                            <select name="user_id" class="select2" {{ !Gate::check('adm_supervisor') ? 'disabled' :  'disabled' }}>
                            ...
                            <div class="app_collapse_content">
                                ...
                                <div class="label_g4">
                                    ...
                                    <label class="label"> <span class="legend">Área Útil:</span>
                                        <input type="text" id="area_util" name="area_util" placeholder="Quantidade de M&sup2;" value="{{ old('area_util') }}" />
                                    </label>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        var valorInput = document.getElementById('area_util');
