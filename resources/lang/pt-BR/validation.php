...
return [
    ...
    */
    ...
    'required_checklist'   => 'O campo checklist é obrigatório.',
    ...
    */
    ...
    'custom' => [
        ...
        'reason_mobilization_id' => [
            'required_if'          => 'O campo :attribute é obrigatório quando :other for não.',
        ],
        'reason_entry_id' => [
            'required_if'          => 'O campo :attribute é obrigatório quando :other for não.',
        ]
    ...
    */
    ...
    'attributes' => [
        ...
        'sector_allocation_id'  => 'setor de alocação',
        'register_date'         => 'data de cadastro',
        'unit_measurement'      => 'unidade de medida',
        'inventory'             => 'estoque minimo',
        'manufacturer'          => 'fabricante',
        'product_group'         => 'grupo de produtos',
        'manufacturer_name'     => 'nome do fornecedor',
        'fiscal_note'           => 'nota fiscal',
        'quantity_format.*'     => 'quantidade',
        'responsible'           => 'responsável',
        'reason_dismissal_id'   => 'motivo da baixa',
        'inspect_date'          => 'data de inspeção',
        'user_id'               => 'usuario',
        'equipment_id'          => 'equipamento',
        'hour_entry_factory'    => 'horario da chegada da equipe',
        'hour_activies_mobilization' => 'hora de inicio da atividade',
        'reason_mobilization_id' => 'motivo da mobilização de atividade',
        'reason_entry_id'       => 'motivo da mobilização de entrada na fabrica',
        'entry_factory'         => 'entrada na fabrica',
        'activies_mobilization' => 'mobilização de atividade',
        'type'                  => 'tipo',
        'id_user'               => 'id do usuario',
        'company'               => 'empresa',
        'nature_activity'       => 'natureza de atividade',
        'action_taken'          => 'ações tomadas',
        'additional_information' => 'informações adicionais',
        'deadline'              => 'prazo',
        'equipment'             => 'equipamento',
        'inspect_category'      => 'categoria'
